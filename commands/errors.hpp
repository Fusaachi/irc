...
#define ERR_TOOMANYTARGETS(target) "407 " + std::string(target) + " :Duplicate recipients. No message delivered\r\n"
#define ERR_NOORIGIN(msg) "409 " + std::string(msg) + " :No origin specified\r\n"
#define ERR_NORECIPIENT(command) "411 : " + std::string(command) + "No recipient given\r\n"
