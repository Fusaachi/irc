...
#define ERR_CANNOTSENDTOCHAN(nick, channel) "404 " + std::string(nick) + " " + std::string(channel) + " :Cannot send to channel\r\n"
...
#define ERR_NEEDMOREPARAMS(nick, command) "461 " + std::string(command) + " :Not enough parameters\r\n"
